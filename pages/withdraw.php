...
<select name="system" class="form-control">
    ...
    <option value="ya">Яндекс.Деньги
	<option value="webmoney">Webmoney
    <option value="visa_mastercard">Visa Mastercard
</select><!-- (+3% к комиссии)-->
<br>
<input type="text" name="target" class="form-control" value="<?=$card['qiwi']?>" placeholder="Номер / Идентификатор счёта" required><br>
<div id="floatingBarsG">
	<div class="blockG" id="rotateG_01"></div>
	<div class="blockG" id="rotateG_02"></div>
	<div class="blockG" id="rotateG_03"></div>
...
<div class="row">
	<div class="col-sm-10 col-xs-8">
		<input type="number" name="sum" min='1' max='<?=$card['lim_one']?>' class="form-control" value="1">
		<span id="alrt">
		</span>
	</div><div class="col-sm-2 col-xs-4" style="     text-align: left;   line-height: 34px;">БР</div>
</div><br>
<input type="hidden" name="b" value="<?=$b?>">
<button type="submit" id="submit123" class="btn btn-success btn-lg">Вывести BCR</button>
</form>
...
<div class="check"><div style="text-align:center;">Выдача наличных</div></div>

<div class="money"></div>

<div class="balance">В банкомате <span><?=$balance?></span> Р</div>

<div class="yourlim">Ваш лимит <span></span> БР<script>setInterval(function(){$('.yourlim span').load('/ajax/yourlim.php');},5000);$('.yourlim span').load('/ajax/yourlim.php');</script></div>

<div class="referals" style="position: absolute;line-height: 17px;left: 52px;top: 348px; width: 191px; font-size: 15px; text-align: center;"><span></span><a href="/referals" class="btn btn-info btn-sm">Порекомендовать систему<br>(оплачивается)</a></div>
