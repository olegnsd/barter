...
<div class="col-md-4 col-xs-12">
    <a href="/withdraw?b=<?=$b_a?>" class="bankomats" title="<?=$title?>" style="pointer-events: <?=$none?>; ">
        <div class="bank" style="background:url('../img/bank<?=$b?>.png'); opacity: <?=$class_hid?>;">
            <div class="screen">
                <div class="content">
                    <b>Снятие наличных</b>
            ...
            <div class="yourlim">Ваш лимит <span></span> БР<script>setInterval(function(){$('.yourlim span').load('/ajax/yourlim.php');},5000);$('.yourlim span').load('/ajax/yourlim.php');</script>
            </div>
            <div class="referals7"><span></span><?=$title_b?></div>
        </div>
    </a>
